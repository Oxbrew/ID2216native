package com.darthvader11.bandlink.MessagingNetwork
...
class MessagingAPI {
    ...
    fun getSessions(userId: Int, callback: Callback): Call {
        val url = "http://calincapitanu.com/GetSessions.php"
    ...
    fun postMessage(messageRequest: MessageRequest, callback: Callback): Call {
        ...
        val url = "http://calincapitanu.com/PostMessage.php"
        val uri = Uri.parse(url)
            .buildUpon()
            .build()
    ...
    fun getMessages(sessionId: Int, callback: Callback): Call {
        val url = "http://calincapitanu.com/GetMessages.php"
        val uri = Uri.parse(url)
            .buildUpon()
    ...
    fun postSession(messageSessionRequest: MessageSessionRequest, callback: Callback): Call {
        ...
        val url = "http://calincapitanu.com/PostSession.php"
        val uri = Uri.parse(url)
            .buildUpon()
            .build()
    ...
    fun getUsers(callback: Callback): Call {
        val url = "http://calincapitanu.com/GetUsersBgr.php"
        val uri = Uri.parse(url)
            .buildUpon()
            .build()
